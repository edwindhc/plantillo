        ...
        <div class="col-md-12 center-block post-block">
            <h4 class="text-center welcome-head">
                ...
                <span class="dropdown topLink">
                    <span data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><?php echo trans('codercv.viral'); ?></span>
                ...
                <span class="dropdown topLink">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?php echo url('/'); ?>"><i class="fa fa-bolt latest"></i> <?php echo trans('codercv.latest'); ?></a></li>
                        <li><a href="<?php echo url('/?'.trans('codercv.sort').'='.strtolower(trans('codercv.popularity'))); ?>"><i class="fa fa-star popular"></i> <?php echo trans('codercv.popularity'); ?></a></li>
                        <li><a href="<?php echo url('/?'.trans('codercv.sort').'='.strtolower(trans('codercv.like'))); ?>"><i class="fa fa-thumbs-o-up like"></i> <?php echo ucfirst(trans('codercv.most')).' '.trans('codercv.like'); ?></a></li>
                        <li><a href="<?php echo url('/?'.trans('codercv.sort').'='.strtolower(trans('codercv.love'))); ?>"><i class="fa fa-heart-o heart"></i> <?php echo ucfirst(trans('codercv.most')).' '.trans('codercv.love'); ?></a></li>
                        <li><a href="<?php echo url('/?'.trans('codercv.sort').'='.strtolower(trans('codercv.sad'))); ?>"><i class="fa fa-frown-o broken"></i> <?php echo ucfirst(trans('codercv.most')).' '.trans('codercv.sad'); ?></a></li>
                        <li><a href="<?php echo url('/?'.trans('codercv.sort').'='.strtolower(trans('codercv.dislike'))); ?>"><i class="fa fa-thumbs-o-down dislike"></i> <?php echo ucfirst(trans('codercv.most')).' '.trans('codercv.dislike'); ?></a></li>
                    </ul>
                </span>
            </h4>
            <p class="text-center muted"><?php echo trans('codercv.today').' '.trans('codercv.most').' '.trans('codercv.popular').' '.ucfirst(env('URL_NAME', 'post')); ?></p>
            <div class="">
                <div class="contentInfinite" data-href="<?php echo url('fetch/'.env('URL_NAME', 'post')); ?>"></div>
            </div>
        </div>
    </div>
</div>
                    ...
                    jQuery.data( this, "infinitePageCheck", setTimeout(function() {
                        ...
                        if(scroll_position_for_posts_load >= jQuery(document).height()) {
                            jQuery.ajax({
                                ...
                                type: 'get',
                            <?php if(isset($_GET[trans('codercv.sort')]) && $_GET[trans('codercv.sort')] == strtolower(trans('codercv.like'))): ?>
                                data: '<?php echo trans('codercv.sort').'='.strtolower(trans('codercv.like')); ?>&userAgent='+encodeURIComponent('CoderCV 1.0.1 - Moz - NonCli-Browser'),
                            <?php elseif(isset($_GET[trans('codercv.sort')]) && $_GET[trans('codercv.sort')] == strtolower(trans('codercv.love'))): ?>
                                data: '<?php echo trans('codercv.sort').'='.strtolower(trans('codercv.love')); ?>&userAgent='+encodeURIComponent('CoderCV 1.0.1 - Moz - NonCli-Browser'),
                            <?php elseif(isset($_GET[trans('codercv.sort')]) && $_GET[trans('codercv.sort')] == strtolower(trans('codercv.sad'))): ?>
                                data: '<?php echo trans('codercv.sort').'='.strtolower(trans('codercv.sad')); ?>&userAgent='+encodeURIComponent('CoderCV 1.0.1 - Moz - NonCli-Browser'),
                            <?php elseif(isset($_GET[trans('codercv.sort')]) && $_GET[trans('codercv.sort')] == strtolower(trans('codercv.dislike'))): ?>
                                data: '<?php echo trans('codercv.sort').'='.strtolower(trans('codercv.dislike')); ?>&userAgent='+encodeURIComponent('CoderCV 1.0.1 - Moz - NonCli-Browser'),
                            <?php elseif(isset($_GET[trans('codercv.sort')]) && $_GET[trans('codercv.sort')] == strtolower(trans('codercv.popularity'))): ?>
                                data: '<?php echo trans('codercv.sort').'='.strtolower(trans('codercv.popularity')); ?>&userAgent='+encodeURIComponent('CoderCV 1.0.1 - Moz - NonCli-Browser'),
                            <?php else: ?>
                                data: 'userAgent='+encodeURIComponent('CoderCV 1.0.1 - Moz - NonCli-Browser'),
                            <?php endif; ?>
                                beforeSend: function() {
                                    jQuery('div#update').html('<div class="alert text-success message fa-lg text-center"><i class="fa fa-spin fa-spinner"></i> <?php echo trans('codercv.loading'); ?></div>');
                                },
