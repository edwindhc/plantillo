        ...
        <div class="col-md-12 center-block post-block">
            <h4 class="text-center welcome-head">
                ...
                <span class="dropdown topLink">
                    <span data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{!! trans('codercv.viral') !!}</span>
                ...
                <span class="dropdown topLink">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{!! url('/') !!}"><i class="fa fa-bolt latest"></i> {!! trans('codercv.latest') !!}</a></li>
                        <li><a href="{!! url('/?'.trans('codercv.sort').'='.strtolower(trans('codercv.popularity'))) !!}"><i class="fa fa-star popular"></i> {!! trans('codercv.popularity') !!}</a></li>
                        <li><a href="{!! url('/?'.trans('codercv.sort').'='.strtolower(trans('codercv.like'))) !!}"><i class="fa fa-thumbs-o-up like"></i> {!! ucfirst(trans('codercv.most')).' '.trans('codercv.like') !!}</a></li>
                        <li><a href="{!! url('/?'.trans('codercv.sort').'='.strtolower(trans('codercv.love'))) !!}"><i class="fa fa-heart-o heart"></i> {!! ucfirst(trans('codercv.most')).' '.trans('codercv.love') !!}</a></li>
                        <li><a href="{!! url('/?'.trans('codercv.sort').'='.strtolower(trans('codercv.sad'))) !!}"><i class="fa fa-frown-o broken"></i> {!! ucfirst(trans('codercv.most')).' '.trans('codercv.sad') !!}</a></li>
                        <li><a href="{!! url('/?'.trans('codercv.sort').'='.strtolower(trans('codercv.dislike'))) !!}"><i class="fa fa-thumbs-o-down dislike"></i> {!! ucfirst(trans('codercv.most')).' '.trans('codercv.dislike') !!}</a></li>
                    </ul>
                </span>
            </h4>
                    ...
                    jQuery.data( this, "infinitePageCheck", setTimeout(function() {
                        ...
                        if(scroll_position_for_posts_load >= jQuery(document).height()) {
                            jQuery.ajax({
                                ...
                                type: 'get',
                            @if(isset($_GET[trans('codercv.sort')]) && $_GET[trans('codercv.sort')] == strtolower(trans('codercv.like')))
                                data: '{!! trans('codercv.sort').'='.strtolower(trans('codercv.like')) !!}&userAgent='+encodeURIComponent('CoderCV 1.0.1 - Moz - NonCli-Browser'),
                            @elseif(isset($_GET[trans('codercv.sort')]) && $_GET[trans('codercv.sort')] == strtolower(trans('codercv.love')))
                                data: '{!! trans('codercv.sort').'='.strtolower(trans('codercv.love')) !!}&userAgent='+encodeURIComponent('CoderCV 1.0.1 - Moz - NonCli-Browser'),
                            @elseif(isset($_GET[trans('codercv.sort')]) && $_GET[trans('codercv.sort')] == strtolower(trans('codercv.sad')))
                                data: '{!! trans('codercv.sort').'='.strtolower(trans('codercv.sad')) !!}&userAgent='+encodeURIComponent('CoderCV 1.0.1 - Moz - NonCli-Browser'),
                            @elseif(isset($_GET[trans('codercv.sort')]) && $_GET[trans('codercv.sort')] == strtolower(trans('codercv.dislike')))
                                data: '{!! trans('codercv.sort').'='.strtolower(trans('codercv.dislike')) !!}&userAgent='+encodeURIComponent('CoderCV 1.0.1 - Moz - NonCli-Browser'),
                            @elseif(isset($_GET[trans('codercv.sort')]) && $_GET[trans('codercv.sort')] == strtolower(trans('codercv.popularity')))
                                data: '{!! trans('codercv.sort').'='.strtolower(trans('codercv.popularity')) !!}&userAgent='+encodeURIComponent('CoderCV 1.0.1 - Moz - NonCli-Browser'),
                            @else
