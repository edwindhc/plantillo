            ...
            <div class="col-sm-9">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <h4>{!! ucfirst(trans('codercv.upload')) !!}</h4>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if(strlen($post->title) > 2)
                                                <a target="_blank" class="btn btn-info" href="{!! url(env('URL_NAME', 'post').'/'.$post->id.'/'.str_slug($post->title)) !!}"><i class="fa fa-eye"></i> {!! trans('codercv.view_post') !!}</a>
                                            @else
                                                <a target="_blank" class="btn btn-info" href="{!! url(env('URL_NAME', 'post').'/'.$post->id.'/'.str_slug($settings->title)) !!}"><i class="fa fa-eye"></i> {!! trans('codercv.view_post') !!}</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
