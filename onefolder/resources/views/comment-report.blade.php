                            ...
                            <table id="myTable" class="table table-bordered table-hover table-condensed table-striped  dt-responsive">
                                ...
                                @foreach($posts as $post)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="javascript:void(0)" data-href="{!! url('report/comment/ok/'.$post->id) !!}" data-confirm="yes" data-confirmation="{!! trans('codercv.confirmation_ask') !!}" class="btn btn-info ajaxified">{!! trans('codercv.mark_as_ok') !!}</a> or
                                            <a href="javascript:void(0)" class="ajaxified btn btn-danger" data-href="{!! url('delete/comment/'.$post->id) !!}" data-confirm="yes" data-confirmation="{!! trans('codercv.confirmation_ask') !!}">{!! trans('codercv.delete') !!}</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
